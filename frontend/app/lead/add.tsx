...
export default function AddLeadScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Éxito', 'Lead agregado correctamente', [
        {
          text: 'OK',
          onPress: () => router.back(),
        },
      ...
      Alert.alert('Error', error.message || 'Error al agregar el lead');
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.radioGroup}>
              <TouchableOpacity
                style={[styles.radioButton, interestType === 'compra' && styles.radioButtonActive]}
                onPress={() => setInterestType('compra')}
              >
                <Text style={[styles.radioText, interestType === 'compra' && styles.radioTextActive]}>
                  Compra
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.radioButton, interestType === 'arriendo' && styles.radioButtonActive]}
                onPress={() => setInterestType('arriendo')}
              >
                <Text style={[styles.radioText, interestType === 'arriendo' && styles.radioTextActive]}>
                  Arriendo
                </Text>
              </TouchableOpacity>
            </View>
          ...
          <View style={styles.inputGroup}>
            ...
            <ScrollView horizontal style={styles.statusSelector}>
              {[
          ...
          <View style={styles.inputGroup}>
            ...
            <ScrollView horizontal style={styles.sourceSelector}>
              {[
                { value: 'web', label: 'Web' },
                ...
                <TouchableOpacity
                  key={item.value}
                  style={[styles.sourceChip, source === item.value && styles.sourceChipActive]}
                  onPress={() => setSource(item.value)}
                >
                  <Text style={[styles.sourceChipText, source === item.value && styles.sourceChipTextActive]}>
                    {item.label}
                  </Text>
                </TouchableOpacity>
              ))}
